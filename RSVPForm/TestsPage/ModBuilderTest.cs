...
{
    [TestFixture]
    public class ModBuilderTest
    {
        [Test]
        public void ModBuilderTestForm()
        {
            ...
            using (var driver = DriverUtils.CreateWebDriver())
            {
                ...
                rsvpForm.CheckedYes();
                Thread.Sleep(2000);
                //"DESIGNER",  "ARCHITECT", "SERVICE TECH","SALES ASSOCIATE",  "BUILDER","INSTALLER",
                rsvpForm.YourProfession("BUILDER");
                Thread.Sleep(2000);
