...
{
    [TestFixture]
    public class ModernismNegativeTest
    {
        [Test]
        public void ModenismNegTestForm()
        {
            ...
            using (var driver = DriverUtils.CreateWebDriver())
            {
                ...
                rsvpForm.YourProfession("DESIGNER");
                Thread.Sleep(2000);
